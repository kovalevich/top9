...
class Application_Form_Form extends Zend_Form
{
    ...
    public function __construct()
    {
        ...
        $data = array(
            ...
            Zend_Validate_NotEmpty::IS_EMPTY => 'Значение является обязательным и не может быть пустым',
            ...
            Zend_Validate_Db_NoRecordExists::ERROR_RECORD_FOUND => 'В базе данных уже присутствует такое значение',
            Zend_Validate_File_Upload::NO_FILE => 'Файл "%value%" не загружен',
    ...
    public function datapopulate($values)
    {
